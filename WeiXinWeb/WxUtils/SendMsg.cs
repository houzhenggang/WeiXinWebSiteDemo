...
namespace WxUtils
{
    public class SendMsg
    {
        ...
        private static string ProduceText(Dictionary<string, string> model, string content)
        {
        ...
        private static string ProduceImage(Dictionary<string, string> model, string mediaId)
        {
        ...
        private static string ProduceVoice(Dictionary<string, string> model, int mediaId)
        {
            ...
            return Templete.SendVoice(voice);
        }
        ...
        /// Company : 123
        /// Created : 2014-10-24 10:25:01
        private static string ProduceVideo(Dictionary<string, string> model, int mediaId, string title, string description)
        {
           ...
           return Templete.SendVideo(video);
        }
        ...
        /// Company : 123
        /// Created : 2014-10-24 10:25:01
        private static string ProduceMusic(Dictionary<string, string> model, string title, string description, string musicUrl, string hqMusicUrl, int thumbMediaId)
        {
            ...
            return Templete.SendMusic(music);
        }
        ...
        private static string ProduceNews(Dictionary<string, string> model, List<ArticlesModel> articles)
        {
        ...
        public static string ReplyTexts(Dictionary<string, string> model,string replyText)
        {
            string content = string.Format("您输入的内容1为：{0}", replyText);
            return ProduceText(model, content);
        }

        public static string ReplyNews(Dictionary<string, string> model,List<ArticlesModel> articles)
        {

          return  ProduceNews(model, articles);
        }
        /// <summary>
        ///  回复扫码推事件消息
        /// </summary>
